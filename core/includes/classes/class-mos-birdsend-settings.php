 ...
 * 
 * MOSBIRDSEND->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Mos_Birdsend_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		MOSBIRDSEND
 * @subpackage	Classes/Mos_Birdsend_Settings
 * @author		Martin Cao
 * @since		1.0.0
 */
class Mos_Birdsend_Settings{
	...
	/**
	 * Our Mos_Birdsend_Settings constructor 
	...
	function __construct(){
		...
		$this->plugin_name = MOSBIRDSEND_NAME;
	...
	public function get_plugin_name(){
		return apply_filters( 'MOSBIRDSEND/settings/get_plugin_name', $this->plugin_name );
	}
	...
	public function get_capability( $identifier = 'default' ) {
		...
		return apply_filters( 'MOSBIRDSEND/settings/get_capability', $capability, $identifier, $this->capabilities );
	}
