...
function test_method() {
    $client = new Client([
        'base_uri' => 'https://fa9438717d678d74b5cb20e6e5b41923.m.pipedream.net',
        'timeout'  => 2.0,
        'headers' => [
    ...
    $response = $client->get('https://fa9438717d678d74b5cb20e6e5b41923.m.pipedream.net', $request_args);
